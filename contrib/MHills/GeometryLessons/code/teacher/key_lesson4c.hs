...
myPicture points = 
    ...
    messages [ "length AB = "++ show (dist a b) 
             ...
             , "angle ABC = "++show (angle a b c)
             , "angle BAC = "++show (angle b a c)
             , "angle BCA = "++show (angle b c a)
             , "angle A'B'C' = "++show (angle a' b' c')
             , "angle B'A'C' = "++show (angle b' a' c')
             , "angle B'C'A' = "++show (angle b' c' a')
             ]
